...
// rungs are the lengths a warmup rehearses, in seconds. The Vulkan backend
...
//
// Rounding utterances up to a rung instead was tried and reverted. It makes
...
var rungs = []int{1, 2, 3, 5, 7, 10, 15, 20, 25, 30}

// Warm is the lengths in seconds to rehearse for a model that accepts at most
// max, 0 for no limit. Nothing in the menu declares less than the last rung.
//
// Past the last rung nothing is rehearsed, and that is deliberate: dictation
